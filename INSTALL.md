...
## Supported base for Station 11.32 Host
...
Release 11.32 full/core bootstrap additionally installs the native Stepper,
...
11.32 immutable Station kernel first, preserving the Host's desired state. Then
...
Station 11.32 publishes beside earlier releases; it never overwrites an old
