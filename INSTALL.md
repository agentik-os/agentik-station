...
## Supported base for Station 11.38 Host
...
Release 11.38 full/core bootstrap additionally installs the native Stepper,
...
11.38 immutable Station kernel first, preserving the Host's desired state. Then
...
Station 11.38 publishes beside earlier releases; it never overwrites an old
