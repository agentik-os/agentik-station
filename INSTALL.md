...
## Supported base for Station 11.36 Host
...
Release 11.36 full/core bootstrap additionally installs the native Stepper,
...
11.36 immutable Station kernel first, preserving the Host's desired state. Then
...
Station 11.36 publishes beside earlier releases; it never overwrites an old
