...
## Supported base for Station 11.39 Host
...
Release 11.39 full/core bootstrap additionally installs the native Stepper,
...
11.39 immutable Station kernel first, preserving the Host's desired state. Then
...
Station 11.39 publishes beside earlier releases; it never overwrites an old
