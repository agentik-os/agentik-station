...
Composite OS composition still follows the AGK OS Contract and capability boundaries. Cross-scope calls are explicit edges in the Loop-Graph with evidence.
