...
| `personal-projects` | Gareth-owned projects | per-project refs | per-project | yes per project | scoped | deny |
...
gareth-private     private-self Hermes home
gareth-projects    personal-project controller; per-project containers/volumes
...
For a highly sensitive personal project, promote it from `gareth-projects` into its own Unix user or dedicated Node.
