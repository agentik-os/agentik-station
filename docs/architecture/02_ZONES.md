...
The category name is not repeated in the child name. Use `4_ORGANIZATIONS/organization-alpha/dev`, not `4_ORGANIZATIONS/organization-alpha-client/client-dev-zone`.
